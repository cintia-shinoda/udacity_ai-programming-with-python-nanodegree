...
| | [3. Data Structures](https://github.com/cintia-shinoda/udacity_ai-programming-with-python-nanodegree/blob/master/2-Intro%20to%20Python%20for%20AI%20Programmers/Lesson%203%20-%20Data%20Structures.md) | <ul><li>[x] 1. Introduction</li><li>[x] 2. Lists and Membership Operators</li><li>[x] 3. Mutability and Order</li><li>[x] 4. Quiz: Lists and Membership Operators</li><li>[x] 5. Solution: Lists and Membership Operators</li><li>[x] 6. List Methods</li><li>[x] 7. Quiz: List Methods</li><li>[x] 8. Check for Understanding: Lists</li><li>[x] 9. Tuples</li><li>[x] 10. Quiz: Tuples</li><li>[] 11. Sets</li><li>[] 12. Quiz: Sets</li><li>[] 13. </li><li>[] 14. Quiz: </li><li>[] 15. Solution: </li></ul> |
